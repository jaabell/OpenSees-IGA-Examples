...
>>>>>>> dedb2be49e27c5b36b5e546a06e35ab01e54928d
tagPlaneStress1 = 3
...
<<<<<<< HEAD
# ops.recorder("mpco","iga_cantilever","-N","displacement","-E","stresses","-E","strains", "-E", "materialAn")
...
print("ops.nodeDisp(7,2): ", 1000*ops.nodeDisp(15, 3), "mm")
...
U = file['MODEL_STAGE[1]']['RESULTS']['ON_NODES']['DISPLACEMENT']['DATA']['STEP_0'][:,:]
shapeU = np.shape(U)
