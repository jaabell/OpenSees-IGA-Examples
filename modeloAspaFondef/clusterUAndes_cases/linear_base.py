...
input_path = 'iga_inputs/case00_190609_11_21_47_ypp.txt'
...
# 7 Hz case
# Getting data from input file
# input_path = 'iga_inputs/case01_190715_13_20_05_y_base.txt'
input_path = 'iga_inputs/case01_190613_16_08_36_ypp.txt'
Ypp_input = np.loadtxt(input_path,skiprows=1)
# nData_input = 3003
nData_input = len(Ypp_input)
dT_input = 0.00333
...
def fatigueAnalysis(i_cycle,t_Final,t_steadyState):
    ...
    lastNode = i_output[-1]
    ops.recorder('Node', '-file', f'output/Linear_fatigue_{i_cycle}.out', '-closeOnWrite', '-time', '-node', *[lastNode], '-dof', *[2], *['accel'])
...
while nCycles < nCycles_max:
    ...
    while nCycles < nCycles_this:
        ...
        ops.recorder("mpco",f"output/aspa_linear_{iTest}",
            "-N","displacement",
