...
# container.vis = VisMPL.VisSurface(ctrlpts=False)
...
ops.nDMaterial("ElasticOrthotropicPlaneStress",
               tagPlaneStress2, 1e0*E1_0, 1e0*E1_0, 0, 0, 0, 1)

# [ 11.58013114  26.14257168  40.26786332  87.28691596 101.27554243
#  142.01103701]
# [ 12.1486059   26.65776404  42.07114978  89.71994325 102.80145543
#  149.96307203]
# [ 12.80205562  27.15781001  45.26870274  93.61054568 105.66454407
#  161.68091692]
# [ 14.06026105  28.02002511  53.43348906 100.38485989 117.69382706
#  179.2490236 ]
# [ 17.38386605  30.31240135  65.79974312 110.04676743 143.06691011
 # 191.0099255 ]
...
for (tag,E) in zip([3,4,5,6,7,8],E_s):
    ...
    G12 = E1/61600e6 * 4488.0e6    # Shear modulus
...
for bendingStrip_name in bendingStrips_data:
    ...
    print('Bending Strip surface_name = ', surface_name)
...
def fatigueAnalysis(i_cycle,t_Final,t_steadyState):
    ...
    ops.recorder('Node', '-file', f'Linear_fatigue_{i_cycle}.out', '-closeOnWrite', '-time', '-node', *[3033], '-dof', *[2], *['disp'])
    ops.recorder('Node', '-file', f'Linear_fatigue_tip_{i_cycle}.out', '-closeOnWrite', '-time', '-node', *[2097], '-dof', *[2], *['disp'])
    ...
    while current_time<t_Final:
        ...
        for i in algorithm:
            ...
            if algorithm[i] == 'Linear':
                # ops.algorithm(algorithm[i],'-factorOnce')
