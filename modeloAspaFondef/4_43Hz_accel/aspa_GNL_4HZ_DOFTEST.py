...
tagPlaneStress2 = 2
ops.nDMaterial("ElasticOrthotropicPlaneStress",
               tagPlaneStress2, 1e1*E1, 1e1*E2, nu12, nu21, 1e1*G12, rho)
...
# Create recorder
ops.recorder('Node', '-file', 'GNL4HZ.out', '-closeOnWrite', '-time', '-node', *[3100], '-dof', *[2], *['disp'])
...
while current_time<tFinal:
    ...
    fileName_stl = f'/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/4_43HZ/figuresGNL4HZ/surf_{surfName}.stl'
    surfName+=1
