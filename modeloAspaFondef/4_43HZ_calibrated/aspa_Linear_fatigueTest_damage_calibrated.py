...
for (tag,E) in zip([3,4,5,6,7,8],E_s):
    ...
    rho = 3181.27*10.157/13.83742381290443 # kg/m^3, desired weight of 11.157 kg
    print('rho = ', rho)
...
def fatigueAnalysis(i_cycle,t_Final,t_steadyState):
    ...
    while current_time<t_Final:
        ...
        fileName_stl = f'/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/4_43HZ_calibrated/figuresLinear_fatigue_{i_cycle}/surf_{surfName}.stl'
        surfName+=1
...
def createFolder(i_cycle):
    ...
    parent_dir = '/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/4_43HZ_calibrated/'
