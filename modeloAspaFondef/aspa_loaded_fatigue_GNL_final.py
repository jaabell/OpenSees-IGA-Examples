...
# t_0 = np.arange(0, t_steady/3, deltaT) 
# t_1 = np.arange(t_steady/3, 2/3*t_steady, deltaT) 
# t_2 = np.arange(2/3*t_steady, t_steady, deltaT) 
# t_3 = np.arange(t_steady, tMax, deltaT) 
# t=np.concatenate([t_0,t_1,t_2,t_3])
...
for j in range(nSteps):
    ...
    if (ops.analyze(1, deltaT) != 0):
        ...
        fileName_stl = f'figuresGNL_final/surf_{j}.stl'
