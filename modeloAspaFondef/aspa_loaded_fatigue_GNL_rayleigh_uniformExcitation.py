...
# Create recorder
ops.recorder('Node', '-file', 'Node3100_Y_GNL.out', '-closeOnWrite', '-time', '-node', *[3100], '-dof', *[2], *['disp'])
...
for j in range(nSteps):
    ...
    for i in algorithm:
        ...
        fileName_stl = f'figures_GNL_Rayleigh/surf_{j}.stl'
