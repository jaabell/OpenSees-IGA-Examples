...
tagPlaneStress2 = 2
ops.nDMaterial("ElasticOrthotropicPlaneStress",
               tagPlaneStress2, 1e0*E1, 1e0*E2, 0, 0, 0, rho)
...
# Create recorder
ops.recorder('Node', '-file', 'Linear16HZ.out', '-closeOnWrite', '-time', '-node', *[3100], '-dof', *[2], *['disp'])
...
while current_time<tFinal:
    ...
    fileName_stl = f'/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/16HZ/figuresLinear16HZ/surf_{surfName}.stl'
    surfName+=1
