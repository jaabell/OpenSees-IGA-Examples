...
# Create recorder
ops.recorder('Node', '-file', 'GNL10HZ.out', '-closeOnWrite', '-time', '-node', *[3100], '-dof', *[2], *['disp'])
...
algorithm = {1:'SecantNewton', 2: 'NewtonLineSearch', 3: "Newton", 4: 'Broyden'}#, 5: 'Broyden'}
...
while current_time<tFinal:
    ...
    fileName_stl = f'/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/10HZ/figuresGNL10HZ/surf_{surfName}.stl'
    surfName+=1
