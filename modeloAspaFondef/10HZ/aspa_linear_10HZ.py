...
# Create recorder
ops.recorder('Node', '-file', 'Linear10HZ.out', '-closeOnWrite', '-time', '-node', *[3100], '-dof', *[2], *['disp'])
...
while current_time<tFinal:
    ...
    fileName_stl = f'/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/10HZ/figuresLinear10HZ/surf_{surfName}.stl'
    surfName+=1
