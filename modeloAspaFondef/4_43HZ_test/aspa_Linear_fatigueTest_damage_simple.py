...
θ_0 = deg2rad*np.array([45.0, -45.0])
θ_1 = deg2rad*np.array([45.0, -45.0])
θ_2 = deg2rad*np.array([45.0, -45.0])
...
def fatigueAnalysis(i_cycle,t_Final,t_steadyState):
    ...
    while current_time<t_Final:
        ...
        fileName_stl = f'/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/4_43HZ_test/figuresLinear_fatigue_{i_cycle}/surf_{surfName}.stl'
        surfName+=1
...
def createFolder(i_cycle):
    ...
    parent_dir = '/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/4_43HZ_test/'

    # directory = f'figuresLinear_fatigue_{i_cycle}'
    directory = f'figuresLinearSimple_fatigue_{i_cycle}'
...
file_modal_Results = open("modalResults_linear_simple.txt",'a')
nCycles_max = 1e9
nCycles = 0
i_cycle = 0
nModes = 6
