...
tagPlaneStress2 = 2
ops.nDMaterial("ElasticOrthotropicPlaneStress",
               tagPlaneStress2, 5e0*E1, 5e0*E2, nu12, nu21, G12, rho)
...
# Create recorder
ops.recorder('Node', '-file', 'Linear4HZ.out', '-closeOnWrite', '-time', '-node', *[3100], '-dof', *[2], *['disp'])
...
while current_time<tFinal:
    ...
    fileName_stl = f'/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/4_43HZ/figuresLinear4HZ/surf_{surfName}.stl'
    surfName+=1
