...
E1 = 48000e6  # Young's modulus N/m^2 Pa
E2 = E1 * 0.500892857
...
ops.recorder('Node', '-file', 'Linear_fatigue.out', '-closeOnWrite', '-time', '-node', *[3033], '-dof', *[2], *['disp'])
...
while current_time<tFinal:
    ...
    fileName_stl = f'/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/4_43HZ/figuresLinear_fatigue/surf_{surfName}.stl'
    surfName+=1
