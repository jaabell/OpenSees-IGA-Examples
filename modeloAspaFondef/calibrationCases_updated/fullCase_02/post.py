...
# Simple model
fileNames = sorted(list(glob.glob("/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/4_43Hz_accel/aspa_linearSimple_*.mpco")))  # Simple model, just to check the damage distribution is continous
...
stages_arr = np.arange(3,len(fileNames)*3,2)
# stages_arr = [3]
