...
# cases = ['case_0','case_01','case_02','case_03', 'case_04', 'case_05', 'case_06']
cases = ['']
...
for case in cases:
  ...
  # Simple model
  fileNames = sorted(list(glob.glob('aspa_linearSimple_*.mpco')))  # Simple model, just to check the damage distribution is continous
  shellName = 'matData/shellSimple'
