...
# uCuts = np.array([0.696])  # Places to define sections
# uCuts = np.array([0.696])  # Places to define sections
...
for i in range(len(uCuts)):
    ...
    operations.insert_knot(surf_top,[0.1,None],[1,0])
    operations.insert_knot(surf_bottom,[0.1,None],[1,0])

    operations.insert_knot(surf_top,[0.9,None],[1,0])
    operations.insert_knot(surf_bottom,[0.9,None],[1,0])
