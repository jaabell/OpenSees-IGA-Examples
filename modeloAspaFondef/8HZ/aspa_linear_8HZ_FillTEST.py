...
ops.recorder('Node', '-file', 'Linear8Hz_filled.out', '-closeOnWrite', '-time', '-node', *[lastNodeTag], '-dof', *[2], *['disp'])
ops.recorder('Node', '-file', 'Linear8Hz_filled_tip.out', '-closeOnWrite', '-time', '-node', *[2320], '-dof', *[2], *['disp'])
...
while current_time<tFinal:
    ...
    fileName_stl = f'/home/rodrigo/FelipeElgueta/OpenSees-IGA-Examples/modeloAspaFondef/8HZ/figuresLinear8HZ/surf_{surfName}.stl'
    surfName+=1
