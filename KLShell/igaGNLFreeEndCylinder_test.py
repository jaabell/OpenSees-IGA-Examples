...
for i in range(len(hingedNodes)):
  ops.equalDOF(int(hingedNodes[i]),int(nextToHingedNodes[i]),1,2,3)
  ops.equalDOF(int(middleNodes[i]),int(nextToMiddleNodes[i]),1,2,3)
...
# Create test
ops.test("NormDispIncr", 1.0e-4, 40, 1)
