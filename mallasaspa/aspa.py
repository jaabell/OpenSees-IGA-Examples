...
bendingStrip_1 = makeBendingStrip(nodesOnRightPatch, interfacePoints, nodesOnLeftPatch) #From top to bottom
...
bendingStrip_2 = makeBendingStrip(nodesOnRightPatch, interfacePoints, nodesOnLeftPatch) #From top to bottom
